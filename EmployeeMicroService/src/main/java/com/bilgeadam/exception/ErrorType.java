...
public enum ErrorType {
    ...
    EMPLOYEE_NOT_FOUND(4112,"Personel bulunamadi..." , HttpStatus.BAD_REQUEST ),
    ...
    EMPLOYEE_NOT_CREATED(4117,"Personel profili olusturulamadi...",HttpStatus.BAD_REQUEST),
    REQUEST_NOT_FOUND(4118,"Personel isteği bulunamadı" ,HttpStatus.BAD_REQUEST );
